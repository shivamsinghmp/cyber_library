...
// py.lstudy.in is admin-only — login already enforces role === "ADMIN".
export async function DashboardShell({
  ...
  // Defense in depth: a session created by a DIFFERENT app must never
  // render this ADMIN-only dashboard just because a session cookie happens
  // to be present.
