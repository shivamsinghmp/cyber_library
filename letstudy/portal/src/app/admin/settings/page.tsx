...
const SECTIONS: SectionConfig[] = [
  ...
  },
  {
    ...
    keys: ["ANNOUNCEMENT", "SUPPORT_EMAIL", "SUPPORT_WHATSAPP_NUMBER", "WHATSAPP_GROUP_LINK", "WHATSAPP_CHANNEL_LINK", "TELEGRAM_CHANNEL_LINK", "GOOGLE_MEET_APP_LINK", "CHECKIN_COINS", "NEXTAUTH_URL"],
  },
  {
    id: "whatsapp",
    title: "WhatsApp API",
