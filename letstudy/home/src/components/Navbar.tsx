...
// Login lives on the student portal subdomain, not on the home/marketing app
const APP_LOGIN_URL = `${process.env.NEXT_PUBLIC_APP_URL || "https://app.lstudy.in"}/login`;
                ...
                <>
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      signOut({ callbackUrl: APP_LOGIN_URL });
                    }}
