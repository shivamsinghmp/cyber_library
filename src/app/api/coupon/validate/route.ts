...
/**
 * Validates coupon and returns discount info. Does NOT redeem (no DB write).
 * Use this when user clicks "Apply" on checkout.
 */
export async function POST(request: Request) {
  try {
    ...
    console.error("POST /api/coupon/validate:", e);
